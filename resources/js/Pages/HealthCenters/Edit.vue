        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800">Edit Health Center</h1>
                        <p class="mt-1 text-sm text-gray-600">Update details for {{ center.name }}</p>
                    </div>
            ...
            <div class="bg-white shadow rounded-lg overflow-hidden">
                <form @submit.prevent="submit">
                    <div class="p-6 space-y-6">
                        ...
                        <!-- Status Section -->
                        <div>
                            <h2 class="text-lg font-medium text-gray-900 mb-4 pb-2 border-b border-gray-200">Status</h2>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <!-- Status -->
                                <div>
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Verified centers appear more prominently</p>
                                </div>
                            </div>
                        </div>
...
const form = reactive({
    ...
    type: props.center.type,
    status: props.center.status,
    lat: props.center.lat,
    lng: props.center.lng,
    address: props.center.address,
    description: props.center.description,
    is_verified: props.center.is_verified,
    processing: false,
});

const submit = () => {
    router.put(route('health-centers.update', props.center.id), form, {
...
const reset = () => {
    form.name = props.center.name;
    form.email = props.center.email;
    form.phone = props.center.phone;
    form.type = props.center.type;
    form.status = props.center.status;
    form.lat = props.center.lat;
    form.lng = props.center.lng;
    form.address = props.center.address;
    form.description = props.center.description;
    form.is_verified = props.center.is_verified;
};
</script>
